...
type Account struct {
	...
	CreatedAt    time.Time     `json:"created_at"`
	Transactions []Transaction `gorm:"foreignKey:FromAccountID;refernces:ID" json:"-"`
}
...
type Loan struct {
	...
	Branch       *Branch       `gorm:"foreignKey:BranchID" json:"branch"`
	Amount       float64       `gorm:"type:decimal(15,2)" json:"amount"`
	InterestRate float64       `json:"type:decimal(15,2)" json:"interest_rate"`
...
type CreateLoanRequest struct {
	...
	TermMonths   int     `json:"terms_months" binding:"required,gt=0"`
}
